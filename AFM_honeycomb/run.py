...
def build_simulator():
    ...
    ham.add_bond(0, 1, [-1,0], J_mat_m10)
    ...
    ham.add_bond(0, 1, [0,-1], J_mat_0m1)
...
SKYRMION_PARAMS = {
    ...
    "B_field": [0.0, 0.0, 1.0],  # Tesla，通常可尝试非零 z 场
}
